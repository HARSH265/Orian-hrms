...
import { Typography, Row, Col, List, Card, Spin, Alert, Button, Tabs } from 'antd';
                ...
                <Row gutter={[24, 24]}>
                    ...
                    <Col xs={24} lg={10}>
                         <Card title="Latest Announcements">
                            {announcementStatus === 'loading' && <Spin />}
...
// import KudosFeed from '../components/kudos/KudosFeed';
// import GiveKudosModal from '../components/kudos/GiveKudosModal';
// import { fetchAllUsers } from '../features/directory/directoryThunks';
...
//                 <Row gutter={[24, 24]}>
//                     <Col xs={24} lg={12}>
//                         {(user?.role === 'employee' || user?.role === 'manager' || user?.role === 'hr') && <ClockWidget />}
//                     </Col>
//                     <Col xs={24} lg={12}>
//                         {user?.role !== 'super-admin' && <MyOpenTasksWidget />}
//                     </Col>
//                     <Col xs={24} lg={12}>
//                         {user?.role !== 'super-admin' && <MyLeaveBalancesWidget />}
//                     </Col>
//                 </Row>
//             ),
//         },
...
//             <GiveKudosModal 
//                 visible={isKudosModalVisible}
//                 onCancel={() => setIsKudosModalVisible(false)}
//             />
//         </div>
//     );
// };
